...
PARSE_IPV4_DIR = $(SRCS_DIR)/parse_ipv4
SRC_PARSE_IPV4 = $(addprefix $(PARSE_IPV4_DIR)/, parse_ipv4.c)
HEADERS_PARSE_IPV4 = $(addprefix $(PARSE_IPV4_DIR)/, parse_ipv4.h)

SRCS = $(SRCS_MAIN) $(SRCS_PACKET) $(SRCS_IP_PACKET) $(SRCS_TIME) $(SRCS_ARGS) $(SRC_PARSE_IPV4)

HEADERS = $(HEADERS_PACKET) $(HEADERS_IP_PACKET) $(HEADERS_TIME) $(HEADERS_PING_DATA) $(HEADERS_ARGS) $(PARSE_)

INCLUDE_DIRS = $(addprefix -I, $(PACKET_DIR) $(LIBFT_DIR) $(IP_PACKET_DIR) $(TIME_DIR) $(PING_DATA_DIR) $(ARGS_DIR) $(PARSE_IPV4_DIR))
